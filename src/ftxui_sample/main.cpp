...
// configuration step. It creates a namespace called `temporally_aware_types`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", temporally_aware_types::cmake::project_name, temporally_aware_types::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", temporally_aware_types::cmake::project_version);
      return EXIT_SUCCESS;
    }
